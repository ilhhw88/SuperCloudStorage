...
public class CredentialController {
    ...
    public String getHomePage(
        ...
        model.addAttribute("credentials", this.credentialService.getCredentialListingByUserId(user.getUserId()));
    ...
    public String newCredential(
        ...
        User user = userService.getUserByUsername(userName);
        model.addAttribute("credentials", credentialService.getCredentialListingByUserId(user.getUserId()));
        model.addAttribute("encryptionService", encryptionService);
